...
def upgrade():
    ...
    op.drop_constraint(
        ...
        type_='foreignkey')
    op.drop_constraint(
        'supply_requests_user_id_fkey',
        'supply_requests',
        type_='foreignkey')
    op.drop_constraint(
        'supply_requests_inventory_id_fkey',
        'supply_requests',
        type_='foreignkey')
    op.drop_constraint(
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            'inventory_id',
            sa.INTEGER(),
            server_default=sa.text("nextval('inventory_inventory_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False),
        sa.Column(
            'product_id',
    ...
    op.create_table(
        ...
        sa.Column(
            'store_id',
            sa.INTEGER(),
            server_default=sa.text("nextval('stores_store_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False),
        sa.Column(
            'store_name',
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name='supply_requests_inventory_id_fkey'),
        sa.ForeignKeyConstraint(
            ['user_id'],
            ['users.user_id'],
            name='supply_requests_user_id_fkey'),
        sa.PrimaryKeyConstraint(
            'request_id',
            name='supply_requests_pkey'))
